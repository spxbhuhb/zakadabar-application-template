...
**Note** You can start the backend and/or the frontend directly from IDEAs Gradle panel. However, there is a bug in IDEA
that prevents two gradle tasks running at the same time. If this your second task does not start, open a terminal
and issue the gradle command from the project root directory.
